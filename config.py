...
parser = argparse.ArgumentParser(description='S-GTR:Graph-based Context Reasoning network')
#data
...
#model
parser.add_argument('--backbone_arch1', type=str, default='res50')
parser.add_argument('--backbone_arch2', type=str, default='add_fpn_deform')
...
parser.add_argument('--logs_dir', type=str, metavar='./',
                    default=osp.join(working_dir, 'logs'))
parser.add_argument('--real_logs_dir', type=str, metavar='PATH', default='logs/GTR.pytorch')
